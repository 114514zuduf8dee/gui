...
local CrucifixTool = game:GetObjects("rbxassetid://11789590444")[1] -- Place your model of the crucifix
...
--         local CrucifixTool = game:GetObjects("rbxassetid://11590476113")[1] -- Put in the model of the crucifix
...
local function func(ins)
	...
	if ins:GetAttribute("IsCustomEntity")==true and ins:GetAttribute("ClonedByCrucifix")~=true then
		local Chains = game:GetObjects("rbxassetid://11736092176")[1] -- Model to put in your crucifix chain
...
dupeCrucifix.Event:Connect(function(time, entityRoot)
	local Cross = game:GetObjects("rbxassetid://11789590444")[1] -- Put in your crucifix model
