...
local Window = OrionLib:MakeWindow({Name = "脚本中心（移动端）", HidePremium = false, SaveConfig = true,IntroText = "脚本中心（移动端）", ConfigFolder = "脚本中心（移动端）"})

local hu = Window:MakeTab({
	Name = "通用脚本",
	Icon = "rbxassetid://6403436054",
	PremiumOnly = false
})
...
hu:AddButton({
	...
	Callback = function()
      		loadstring(game:HttpGet("https://raw.githubusercontent.com/zeroisswag/universal-esp/main/esp.lua"))()
                    ...
                    _G.UseTeamColor = false -- can be changed
                    _G.UseEnemyColor = true -- changeable
  	end    
})
...
local Tab = Window:MakeTab({
	Name = "Doors",
	Icon = "rbxassetid://11024699917",
	PremiumOnly = false
})

Tab:AddButton({
	Name = "四神归位（请在商店执行）",
	Callback = function()local OrionLib = loadstring(game:HttpGet(('https://pastebin.com/raw/DrM0eLkh')))()
local Window = OrionLib:MakeWindow({Name = "脚本中心（移动端）", HidePremium = false, SaveConfig = true,IntroText = "脚本中心（移动端）", ConfigFolder = "脚本中心（移动端）"})
...
Tab:AddButton({
	Name = "四神归位（请在商店执行）",
	Callback = function()
      		loadstring(game:HttpGet("https://pastebin.com/raw/RNq5TZ17"))()
  	end    
})
...
local custom = {
    ...
    Reason = "我们终于不用怕那些冲击的怪物了", --change this for second line of the badgs desc
...
Tab:AddButton({
	Name = "rush",
	Callback = function()
      		loadstring(game:HttpGet("https://pastebin.com/raw/UXD91AKv"))()
  	end    
})
...
Tab:AddButton({
	Name = "ambush",
	Callback = function()
      		loadstring(game:HttpGet("https://pastebin.com/raw/hBWFtx2K"))()
  	end    
})
...
Tab:AddButton({
	Name = "trollface",
	Callback = function()
      		loadstring(game:HttpGet("https://pastebin.com/raw/nWPdgzP0"))()
  	end    
})

local huo = Window:MakeTab({
	Name = "Blox Fruits",
	Icon = "rbxassetid://11337649779",
	PremiumOnly = false
})
...
local ojg = Window:MakeTab({
	Name = "伐木大亨 2",
	Icon = "rbxassetid://834666972",
	PremiumOnly = false
})
...
local kr = Window:MakeTab({
	Name = "更新日志",
	Icon = "rbxassetid://10318865684",
	PremiumOnly = false
})

kr:AddParagraph("版本v1","添加按钮king hub")

kr:AddParagraph("版本v1.5","添加分区doors")

kr:AddParagraph("版本v2","增加按钮我的世界小屋子,通用里面的所有内容,增加分区bf")

kr:AddParagraph("版本v2.5","在BF分区增加两个脚本按钮")

kr:AddParagraph("版本v3","增加贴画,移动端和电脑端")

kr:AddParagraph("版本v3.1","增加高级脚本中心")

kr:AddParagraph("版本v3.2","取消高级脚本中心 脚本中心的密钥系统")

local hi = Window:MakeTab({
    Name = "学分",
    Icon = "rbxassetid://10316541288",
    PremiumOnly = false
})

hi:AddParagraph("制作者QQ","3279536952")
        
hi:AddParagraph("如何催更","v作者50 让作者可以去吃kfc")
